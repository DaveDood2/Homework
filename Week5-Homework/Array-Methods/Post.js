...
let user5Posts = data.filter(function(element) {
  return element.userId === 5;
});
console.log("User 5's posts:", user5Posts);
let user5TitleBody = [];
user5Posts.forEach(element => {
  user5TitleBody.push({ title: element.title, body: element.body });
});
console.log(user5TitleBody, user5TitleBody[0]);
